...
export const mobileCaseCopy = {
  ru: {
    ...
    pochtaTitle: "ПРИЛОЖЕНИЕ ПОЧТА БАНКА",
    pochtaStatus: "арт-д • дизайнер",
    pochtaDescription:
    ...
    pochtaCopyOne:
      "Сделал полностью новое приложение. Все разделы и вкладки были переработаны, большая часть UX собрана заново, включая быстрые платежи и решения для роста нужных банковских метрик.",
    pochtaCopyTwo:
      "Переработал иллюстрации, собрал дизайн-систему, гайдлайны, анимации, профили и баннеры.",
    bitrixTitle: "BITRIX 24",
    ...
    bitrixCopyBottomOne: "Но не только сайт",
    bitrixCopyBottomTwo:
    ...
    bitrixCopyBottomThree: "Но в прод это не пошло, поэтому пусть спокойно живёт здесь",
    stolotoTitle: "СТОЛОТО",
    ...
    additionalItems: [
      ["Редизайн M-series", "арт-д, дизайнер"],
      ["Веб-концепт", "дизайнер"],
      ["Интерфейс игровых автоматов", "арт-д, дизайнер"],
      ["Интерфейс постамата", "арт-д, дизайнер"],
      ["Редизайн сайта", "дизайнер"],
      ["Редизайн сайта", "дизайнер"],
      ["Дизайн приложения", "арт-д"],
      ["Редизайн сайта", "дизайнер"],
    ],
  },
  en: {
    ...
    objTitle: "ANOTHER AUTOMOTIVE",
    objStatus: "art-d • designer",
    objCopy:
    ...
    bitrixCopyBottomOne: "But not only website",
    bitrixCopyBottomTwo:
      "I also made a proposal to redisgn a inner system to create a much friendly, connectivity design to work with joy",
    bitrixCopyBottomThree: "But it didn't go to prod, so let it rest here in peace",
    stolotoTitle: "STOLOTO",
    ...
    additionalItems: [
      ["M-series web redesign", "art-d, designer"],
      ["Web concept", "designer"],
      ["Game machines interface", "art-d, designer"],
      ["Interface for postamat", "art-d, designer"],
      ["Web redesign", "designer"],
      ["Web redesign", "designer"],
      ["App design", "art-d"],
      ["Web redesign", "designer"],
    ],
